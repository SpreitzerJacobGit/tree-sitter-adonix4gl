LANGUAGE_NAME := tree-sitter-adonix4gl
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-adonix4gl
VERSION := 1.0.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/adonix4gl '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/adonix4gl
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/adonix4gl
